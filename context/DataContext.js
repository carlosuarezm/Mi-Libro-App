...
import book5 from '../assets/alquimista3.jpg'
...
const DataProvider = ({ children }) => {
    const [libros, setLibros] = useState([bookCleanCode, bookHarry, bookGameOfThrones, bookSherlock, bookAlquimista]);
